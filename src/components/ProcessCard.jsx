...
export const ProcessCard = ({ children, img = '', url = '/#' }) => {
    ...
    return (
        <div 
            ...
            className="flex items-center bg-[#E71567] relative py-7 pl-2 pr-10 xl:px-14 xl:py-3 gap-6 xl:gap-10 min-h-24 xl:h-44 3xl:h-52 rounded-xl xl:rounded-3xl w-max xl:w-[unset]">
