...
export const HomePage = () => {
    ...
    return (
        <section>
            <a href="https://inspiralab.com.mx" target="_blank" className="fixed bottom-7 right-7 flex items-center justify-center z-20 shadow rounded-full cursor-none">
                <div className="size-24 animate-ping absolute bg-pink-700 rounded-full"></div>
                <img src="/img/home/btn-tienda.png" alt="Tienda" width={120} className="z-10"/>
            </a>
            <div className="absolute z-20 w-full h-[300px] bg-gradient-to-b from-[#E71567] to-transparent">
            </div>
